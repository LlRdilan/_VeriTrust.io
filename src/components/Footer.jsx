                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12" style={{ display: 'flex', justifyContent: 'center' }}>
                            <Link className="logo2" to="/"><img src="images/loogo2.png" alt="#" /></Link>
                        </div>
                        <div className="col-lg-5 col-md-6 col-sm-6">
                            <h3>Contáctanos</h3>
                            <ul className="location_icon">
                                <li>
                                    <a href="#"><i className="fa fa-map-marker" aria-hidden="true"></i></a> Antonio Varas 666, Providencia
                                </li>
                                <li>
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-6">
                            ...
                            <ul className="link_icon">
                                ...
                                <li><Link to="/tutorial">Tutoriales</Link></li>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <p>
                                    ...
                                    <a href="https://www.duoc.cl/"> DuocUC</a>
                                </p>
                            </div>
                        </div>
                    </div>
