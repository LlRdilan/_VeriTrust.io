                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-md-6 col-sm-6">
                            ...
                            <ul className="location_icon">
                                <li><a href="#"><i className="fa fa-map-marker" aria-hidden="true"></i></a> Antonio Varas 666, Providencia</li>
                                <li><a href="#"><i className="fa fa-envelope" aria-hidden="true"></i></a>VeriTrust@duocuc.cl</li>
                                <li><a href="#"><i className="fa fa-volume-control-phone" aria-hidden="true"></i></a>+569 1111 1111</li>
                            </ul>
                        ...
                        <div className="col-lg-5 col-md-12 col-sm-12">
                            ...
                            <div className="map-container" style={{ position: 'relative', height: '250px', borderRadius: '8px', overflow: 'hidden', marginTop: '15px' }}>
                                <iframe 
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <p>© 2019 Todos los derechos reservados.<a href="https://html.design/"> Plantillas HTML Gratis</a></p>
                            </div>
                        </div>
                    </div>
                </div>
