        ...
        <div className="row">
          <div className="col-md-7">
            <div className="titlepage">
              <h2>
                <strong className="yellow">Tutoriales</strong> A continuación encontraras algunos tutoriales y
                consejos que debes ver para estar bien informado.
              </h2>
            </div>
          </div>
        </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Este video muestra como todo lo que hacemos en internet afecta nuestra identidad digital.
                </p>
              </div>
            </div>
          </div>
